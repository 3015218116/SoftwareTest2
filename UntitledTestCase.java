...
public class UntitledTestCase {
    ...
    public void testUntitledTestCase() throws Exception {
        ...
        XSSFWorkbook wb = new XSSFWorkbook("/Users/tjliqy/Downloads/input.xlsx");
        ...
        for (int i = sheet.getFirstRowNum(); i < sheet.getPhysicalNumberOfRows(); i++) {
            ...
            HubUrl = row.getCell(cellNum+1).getStringCellValue();
            ...
            if (Url != null && !Url.equals("")) {
                ...
                Web = driver.findElement(By.xpath("//p")).getText();
                System.out.println(userName + ": "+ Web);
                assertEquals(formatUrl(Url), formatUrl(Web));
            }else {
